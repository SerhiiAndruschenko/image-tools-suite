...
export default function AvifConverter() {
  ...
  // Conversion settings
  const [quality, setQuality] = useState(90); // Lower default for better compression
    ...
    try {
      ...
      if (downloadMode === "zip") {
        ...
        for (let i = 0; i < selectedFiles.length; i++) {
          ...
          try {
            const { blob, originalSize, convertedSize, originalDimensions } =
        ...
        const timestamp = new Date()
          ...
          .replace(/[:.]/g, "-")
          .slice(0, 19);
        const zipFileName = `avif-images-${timestamp}.zip`;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-orange-900 to-amber-900">
      <div className="max-w-6xl mx-auto p-6 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Convert images to modern AVIF format for maximum compression and
            file size reduction - achieve up to 90% smaller files while
            maintaining quality!
          </p>
        </div>
        ...
        >
          <div
            className={`absolute inset-0 bg-gradient-to-r from-orange-600/30 to-amber-600/30 rounded-3xl blur-xl transition-opacity duration-300 ${
          ...
          <div
            className={`relative backdrop-blur-sm border-2 border-dashed rounded-3xl p-12 text-center transition-all duration-300 ${
              selectedFiles.length > 0
                ? "border-orange-400 bg-orange-900/20 shadow-2xl shadow-orange-500/20"
                : "border-gray-600 bg-gray-800/80 hover:border-orange-400 hover:bg-gray-800/90 shadow-xl hover:shadow-2xl"
            }`}
          >
            <input
              ref={fileInputRef}
            ...
            {selectedFiles.length === 0 ? (
              <div className="space-y-6">
                <div className="relative">
                  <div className="w-24 h-24 mx-auto bg-gradient-to-r from-orange-500 to-amber-600 rounded-full flex items-center justify-center shadow-2xl glow">
                    <svg
                ...
                <div>
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-2xl shadow-2xl hover:shadow-3xl transform hover:scale-105 transition-all duration-200 glow"
                  >
                    <svg
              ...
              <div className="space-y-6">
                <div className="relative">
                  <div className="w-20 h-20 mx-auto bg-gradient-to-r from-orange-500 to-amber-600 rounded-full flex items-center justify-center shadow-2xl glow">
                    <svg
                      className="w-10 h-10 text-white"
                      fill="none"
                      stroke="currentColor"
            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-lg font-semibold text-gray-200 mb-4">
                  Quality: <span className="text-amber-600">{quality}%</span>
                ...
                <div className="mt-2 text-sm text-gray-400">
                  <span className="text-amber-600">💡 Tip:</span> Use 10-30%
                  quality for maximum file size reduction
                </div>
              </div>
            </div>
          </div>
        ...
        {selectedFiles.length > 0 && (
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-700/20">
            <div className="flex items-center justify-between mb-6">
              ...
              <span className="px-4 py-2 bg-emerald-900/50 text-emerald-300 font-semibold rounded-full text-sm border border-emerald-700/50">
            ...
            <div className="max-h-80 overflow-y-auto space-y-3 custom-scrollbar">
              {selectedFiles.map((file, index) => (
                <div
                  key={index}
                  className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-700/50 to-orange-900/30 rounded-2xl border border-gray-600/50 hover:shadow-lg hover:border-gray-500/50 transition-all duration-200"
                >
        ...
        {/* Download Mode and Convert Button */}
        {selectedFiles.length > 0 && (
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-700/20">
                    ...
                    <div
                      className={`p-6 rounded-2xl border-2 transition-all duration-200 ${
                        downloadMode === "individual"
                          ...
                          : "border-gray-600 bg-gray-700/50 hover:border-orange-400 hover:bg-gray-700/70"
                      }`}
                    >
                      <div className="flex items-center space-x-4">
                        <div
              ...
              <button
                ...
                className={`w-full py-4 px-8 rounded-2xl font-bold text-lg transition-all duration-300 transform ${
                  isConverting
                    ...
                    : "bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white shadow-2xl hover:shadow-3xl hover:scale-105 glow"
                }`}
              >
                {isConverting ? (
                  ...
                  <div className="flex items-center justify-center space-x-3">
                    ...
                    <span>
                      {downloadMode === "zip"
                        ? `Convert ${selectedFiles.length} files to AVIF (ZIP)`
                        : `Convert ${selectedFiles.length} files to AVIF`}
                    </span>
                  </div>
                )}
              </button>
          ...
          <div className="bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-gray-700/20">
            <div className="text-center space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-orange-900/50 to-orange-800/30 p-6 rounded-2xl border border-orange-700/30">
              ...
              <p className="text-amber-600 font-medium">
                {downloadMode === "zip"
                  ? "ZIP archive with all AVIF files has been downloaded to your computer."
                  : "All successfully converted AVIF files have been automatically downloaded to your computer."}
              </p>
            </div>
          </div>
        )}
      ...
      <style jsx>{`
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
          background: linear-gradient(to bottom, #c2410c, #b45309);
        }
